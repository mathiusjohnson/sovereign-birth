      ...
      <div className="main-container">
        ...
        <div className="image-container">
          <div className="process">
            ...
            <img src={this.state.multerImage} alt="uploaded multer" className="process__image" />
          </div>
          ...
          <div className="process">
            ...
            <img src={this.state.firebaseImage} alt="uploaded firebase" className="process__image" />
          </div>
          ...
          <div className="process">
            ...
            <img src={this.state.baseImage} alt="uploaded" className="process__image" />
          </div>
        </div>
